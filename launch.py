...
'nEpiDopa'		: 10				,# number of 'adult' episodes in each run (episodes when reward is not required for learning)				#20
...
'dMid' 			: 1.01 				,# learning rate increase for correct reward prediction
