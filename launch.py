...
net = hebbian_net.Network(	dHigh 				= 4.0,
							...
							name 				= 'ACh_uncert_avg_stim_stopEval_noPretrain',
							dopa_release 		= False, 
							ach_release			= True, 
							n_runs 				= 1,
							n_epi_crit			= 1,
							...
							weight_init 		= 'input',
							init_file			= '',#'digit_pretrain_lr_5e-4_uncertainty_short_stim', #'digit_pretrain_lr_1e-3_10c', #'digit_pretrain_lr_5e-3_ach_stim_3runs',
							lim_weights			= True,
							log_weights 		= True,
							epsilon_xplr 		= 1.0,
							noise_xplr_hid		= 0.3,
