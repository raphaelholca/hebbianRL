...
net = hebbian_net.Network(	dHigh 				= 4.0,#4.0, #6.0,#2.0,#4.0,
							...
							n_hid_neurons		= 25,
							weight_init 		= 'input',
							init_file			= 'Hebb_non_uni',#'digit_pretrain_class_3run_lr_5e-3_achAvg_1', #'digit_pretrain_class_3run_lr_5e-3_noAchAvg' #'digit_pretrain_class_20run_300epi', #'digit_pretrain_class_3run_lr_5e-3',
							lim_weights			= True,
							log_weights	 		= 'log',
							epsilon_xplr 		= 1.0,
							noise_xplr_hid		= 0.3,
