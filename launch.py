...
'nEpiDopa'		: 50				,# number of 'adult' episodes in each run (episodes when reward is not required for learning)				#20
...
'runName' 		: '300_perf'		,# name of the folder where to save results
