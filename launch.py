...
'nEpiCrit'		: 50 				,# number of 'critical period' episodes in each run (episodes when reward is not required for learning)		#50
'nEpiDopa'		: 20					,# number of 'adult' episodes in each run (episodes when reward is not required for learning)				#20
