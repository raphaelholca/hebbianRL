...
net = hebbian_net.Network(	dHigh 				= 4.00,
							...
							name 				= 'long_ACh_8_stimwise_BvSB_noavg_2',
							dopa_release 		= False, 
							ach_release			= True, 
							n_runs 				= 3,
							n_epi_crit			= 0,
							...
							n_hid_neurons		= 49,
							weight_init 		= 'input',
							init_file			= 'digit_pretrain_class_3run_lr_5e-3_noAchAvg', #'digit_pretrain_class_20run_300epi', #'digit_pretrain_class_3run_lr_5e-3',
							lim_weights			= True,
							log_weights	 		= 'log',
							epsilon_xplr 		= 1.0,
							noise_xplr_hid		= 0.3,
