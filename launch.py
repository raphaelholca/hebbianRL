...
'nEpiDopa'		: 20				,# number of 'adult' episodes in each run (episodes when reward is not required for learning)
...
'runName' 		: 'gabor-4-4'			,# name of the folder where to save results
...
'noise_std'		: 0.5 			,# standard deviation of the normal distribution from which noise is drawn										digit: 4.0 	; gabor: 0.01
...
'seed' 			: 997#np.random.randint(1000) 	# seed of the random number generator
}
