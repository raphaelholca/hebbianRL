...
args['rActions'] 	= rActions


""" load and pre-process images """
ex.checkClassifier(args['classifier'])
args['runName'] = ex.checkdir(args['runName'], OW_bool=True)
print 'seed: ' + str(args['seed']) + '\n'
print 'loading data...'
imPath = '/Users/raphaelholca/Documents/data-sets/MNIST'

images, labels = mnist.read_images_from_mnist(classes = args['classes'], dataset = args['dataset'], path = imPath)
...
rl.RLnetwork(images=images, labels=labels, args=args, **args)
