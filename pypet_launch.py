...
""" explored parameters """
explore_dict = {	'dHigh'			: [-1.00, 0.000, 1.000, 2.000, 3.000], #[-1.000, +0.000, +1.000, +2.000, +3.000], #[0.000, 0.800, 1.600, 2.400, 3.200], #
					'dNeut'			: [-0.40, -0.30, -0.20, -0.10, -0.00], #[-0.500, -0.200, -0.100, +0.000, +0.100], #[-0.10, -0.08, -0.06, -0.04, -0.02], #
					
					'dMid'			: [0.000, 0.100, 0.200, 0.300, 0.400], #[-0.050, -0.001, +0.000, +0.001, +0.050], #[0.000, 0.001, 0.005, 0.010, 0.050], #
					'dLow'			: [0.000, -0.80, -1.60, -2.40, -3.20]  #[-1.500, -1.000, -0.500, +0.000, +0.500]  #[0.000, -0.20, -0.40, -0.60, -0.80]  #
				}
