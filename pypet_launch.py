...
parameter_dict = {	'dHigh' 			: 0.0,
					...
					'name' 				: 'pypet_digit_2layers',#'pypet_gabor_t_1-0_newtrainset_2',
					'n_runs' 			: 4,
					'n_epi_crit'		: 20,				
					'n_epi_dopa'		: 100,
					't'					: 0.1,#1.0,#
...
""" explored parameters """
explore_dict = {	'dHigh'			: [+0.000, +0.800, +1.600, +2.400, +3.200], #[+1.000, +2.000, +3.000], #[-1.000, +0.000, +1.000, +2.000, +3.000], #[-1.00, 0.000, 1.000, 2.000, 3.000], #
					'dNeut'			: [-0.100, -0.080, -0.060, -0.040, -0.020], #[-0.200, -0.100, -0.000], #[-0.400, -0.300, -0.200, -0.100, -0.000], #[-0.500, -0.200, -0.100, +0.000, +0.100], #
					
					'dMid'			: [+0.000, +0.001, +0.005, +0.010, +0.050], #[+0.000, +0.001, +0.010], #[+0.000, +0.100, +0.200, +0.300, +0.400], #[-0.050, -0.001, +0.000, +0.001, +0.050], #
					'dLow'			: [+0.000, -0.200, -0.400, -0.600, -0.800]  #[-0.800, -1.600, -2.400]  #[+0.000, -0.800, -1.600, -2.400, -3.200]  #[-1.500, -1.000, -0.500, +0.000, +0.500]  #
				}
